...
public class pruebas {
    ...
    static String valorstr, DatoaBuscar, selecciostr, n;
        ...
        do {
            ...
            Object menu1 = JOptionPane.showInputDialog(null, "Seleccione una opción", "Practica UD2",
                    ...
                    new Object[] { "1. Crear una anotacion", "2. Listar anotaciones existentes",
                            "3. Buscar una anotacion", "4. Eliminar una anotacion", "5. Modificar una anotacion",
            ...
            case "2. Listar anotaciones existentes":
                ...
                String mostrar = "";
                int longitud = anotaciones.length;
                for (int i = 0; i < longitud; i++) {
                    if (anotaciones[i] != null) {
                        mostrar += anotaciones[i];
                        mostrar += "\n";
                    }
                }
            ...
            case "3. Buscar una anotacion":
                ...
                Object menuP3 = JOptionPane.showInputDialog(null, "Seleccione una opción", "Practica UD2 punt3",
                        JOptionPane.QUESTION_MESSAGE, null,
                        new Object[] { "1. Buscar per posicio", "2. Buscar per contingut" }, "1. Buscar per posició");
                ...
                if (selecciostr == "1. Buscar per posicio") {
                    ...
                    JOptionPane.showMessageDialog(null, anotaciones[puesto]);
                    break;
                } else {
                    String contingut = JOptionPane.showInputDialog("Introdueix el contingut a buscar");
                    System.out.println(contingut);
                    String trobades = ""; // inicializamos variable
                    for (int i = 0; i < anotaciones.length; i++) {
                        if (anotaciones[i] != null) {
                            if (anotaciones[i].contains(contingut)) {
                                trobades += "Anotación " + Integer.toString(i) + " ->" + anotaciones[i] + "\n";
                            }
                        }
                    }

                    JOptionPane.showMessageDialog(null, trobades);
                }
